...
export function JobPopup() {
  ...
  const submitQuery = async () => {
    ...
    const config = {
      ...
      precision: (document.getElementById("precision") as HTMLInputElement)
        ?.value,
      modulesLimit: Number(
        (document.getElementById("modules_limit") as HTMLInputElement)?.value
      ),
      loraRank: Number(
        (document.getElementById("r") as HTMLInputElement)?.value
      ),
      loraAlpha: Number(
        (document.getElementById("lora_alpha") as HTMLInputElement)?.value
      ),
      batchSize: Number(
        (document.getElementById("batch_size") as HTMLInputElement)?.value
      ),
      optimizer: (document.getElementById("optim") as HTMLInputElement)?.value,
      warmupSteps: Number(
        (document.getElementById("warmup_steps") as HTMLInputElement)?.value
      ),
      maxSteps: Number(
        (document.getElementById("max_steps") as HTMLInputElement)?.value
      ),
      evalSteps: Number(
        (document.getElementById("eval_steps") as HTMLInputElement)?.value
      ),
      learningRate: Number(
        (document.getElementById("learning_rate") as HTMLInputElement)?.value
      ),
      loggingSteps: Number(
        (document.getElementById("logging_steps") as HTMLInputElement)?.value
      ),
    };
